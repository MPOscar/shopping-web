...
export class AuthService {
    ...
    logout(): void {
        ...
        this.http.httpClient.post(this.configService.apiUrl + this.configService.config.apiConfigs.authentication.revokeUser.apiEndpoint,
    ...
    postUserPreferences(preferences: string): Observable<any> {
        ...
        return this.http.post(this.configService.apiUrl + this.configService.config.apiConfigs.authentication.userPreferences.apiEndpoint,
            preferences);
    }

    getUserPreferences(): Observable<any> {
        let headers = this.getHeaders(true);
        return this.http.get<any>(this.configService.apiUrl + this.configService.config.apiConfigs.authentication.userPreferences.apiEndpoint,
            { headers: headers })
            .pipe(map((response) => {
    ...
    updateExpirationTime(data): Observable<any> {
        return this.http.patch(this.configService.apiUrl + this.configService.config.apiConfigs.authentication.tokenExpirationTime.apiEndpoint, data, { headers: this.getHeaders(true) });
    }

    changePassword(currentPassword: string, newPassword: string): Observable<any> {
        return this.http.patch<any>(this.configService.apiUrl + this.configService.config.apiConfigs.authentication.changePassword.apiEndpoint, {
    ...
    patchUser(data: any, userId: string): Observable<any> {
        return this.http.patch<any>(this.configService.apiUrl + this.configService.config.apiConfigs.users.apiEndpoint + userId + '/', JSON.stringify(data));
    }
