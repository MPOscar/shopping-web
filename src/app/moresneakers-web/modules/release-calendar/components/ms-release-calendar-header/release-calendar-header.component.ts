...
@Component({
  selector: 'ms-release-calendar-header',
  templateUrl: './release-calendar-header.component.html',
  styleUrls: ['./release-calendar-header.component.scss']
})
export class ReleaseCalendarHeaderComponent implements OnInit {
